...
import { depts,Administrators } from '../assets/Data';
        ...
        bg-[#0f0a1a] font-['DM_Sans'] relative overflow-hidden">
          ...
          top-1/2 left-[60%]"
            ...
            focus:border-[#C084C8]/60 focus:bg-[#8A2E88]/10">
                                        <option value="" className='text-gray-800 bg-slate-300'>Select Role</option>

                                        {Administrators.map((admin, idx) => (
                                            <option key={idx} value={admin} className='text-gray-800 bg-slate-300'>
                                                {admin}
                                            </option>
                                        ))}
                                    </select>
